                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                <a href="<?php echo e(route('users.create')); ?>"
                                    class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"> إضافة مستخدم
...
<<<<<<< Updated upstream
                                    ...
                                    <td><button type="button" class="btn btn-info btn-sm btn-rounded waves-effect waves-light"><?php echo e($user->phone); ?></button></td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3">
                                            ...
                                            <a data-bs-toggle="modal" data-bs-target="#kt_modal_2" title="حذف" style="cursor: pointer"  data-id="<?php echo e($user->id); ?>"  class="text-danger">
                                                <i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Documents\GitHub\jadwa\resources\views/admin/users/index.blade.php ENDPATH**/ ?>
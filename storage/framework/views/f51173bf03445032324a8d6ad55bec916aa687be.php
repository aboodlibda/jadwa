            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-shrink-0 me-4">
                        <img src="<?php echo e(url('public/logo/'.$project->logo)); ?>" alt=""  width="50" height="50" class="avatar-sm">
                    </div>
                    ...
                    <table class="table align-middle table-nowrap">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div>
                                    <p class="text-black mb-0 gray"><?php echo e($project->development_duration); ?>شهر </p>                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div>
                                        <p class="text-black mb-0 gray"><?php echo e($dateStartOper); ?></p>                                    </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <p class="text-black mb-0 gray"><?php echo e($year); ?></p>                                    </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <p class="text-black mb-0 gray"><?php echo e($numofday); ?></p>                                    </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <p class="text-black mb-0 gray"><?php echo e($numofmonth); ?></p>                                    </div>
                                    </div>
                                </td>
                            </tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <div>
                                        <p class="text-black mb-0 gray"><?php echo e($project->vat); ?>%</p>                                    </div>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
...
<div class="row">
    <h5 class="font-size-15 mt-5 font-weight-700 pb-10"> الخدمات المتوفرة </h5>
        ...
        <div class="col-lg-4">
            <!-- Simple card -->
        <div class="card">
            <img class="card-img-top img-fluid" src="<?php echo e(url('public/image/'.$services->image)); ?>" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title mt-0 "style="display: -webkit-inline-box;"><?php echo e($services->title); ?> <p class="orange" style=" padding-right: 105px;
                "><?php echo e($services->price); ?>ر.س</p></h4>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Documents\GitHub\jadwa\resources\views/admin/projects/show.blade.php ENDPATH**/ ?>
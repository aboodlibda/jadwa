                                                ...
                                                <div class="text-center">
                                                    <div dir="ltr">
                                                        <div class="owl-carousel owl-theme auth-review-carousel"
                                                            ...
                                                            <div class="item">
                                                                <div class="py-3">
                                                                    <p class="font-size-18 mb-4"><?php echo e($item->title); ?></p>
                                                                    <div>
                                                                        <h4 class="font-size-16"><?php echo e($item->description); ?> </h4>
                                                                    </div>
                                                                </div>
                                                            </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Documents\GitHub\jadwa\resources\views/auth/login.blade.php ENDPATH**/ ?>
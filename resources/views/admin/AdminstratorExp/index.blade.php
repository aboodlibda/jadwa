                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="{{ route('adminstExp.store') }}">
                                                            @csrf
                                                           
                                                            <div class="mb-3">
                                                                <label for="item" class="col-form-label">البند</label>
                                                                <input type="text" name="item" class="form-control" id="item" value="{{ old('item') }}">
                                                            </div>
                                ...
                                <div class="modal-body">
                                   <form method="POST" action="adminstExp/{adminstExp}" id="editModal">
                                        ...
                                        <input type="hidden" id="id" name="id">
                                         ...
                                         <div class="mb-3">
                                            <label for="item" class="col-form-label">البند</label>
                                            <input type="text" name="item" class="form-control" id="item" value="{{ $adminstExp->item }}">
                                        </div>  
                
                                        <div class="mb-3">
                                            <label for="value" class="col-form-label">القيمة</label>
                                            <input type="text" name="value" class="form-control" id="value" value="{{ $adminstExp->value }}">
                                        </div>  
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>

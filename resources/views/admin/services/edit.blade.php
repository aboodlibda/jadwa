...
@section('title') {{'تعديل خدمة'}} @endsection

@section('content')

    @component('components.breadcrumb')
        @slot('li_1') خدمة @endslot
        @slot('title') تعديل خدمة @endslot
    @endcomponent
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ $service->title }}" id="title" >
                                    @error('title')
                           ...
                           <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" value="{{$service->price}}" id="price" >
                                    @error('price')
                                    <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                      ...
                      <div class="row">
                         ...
                         <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                @if($service->image)<img src="{{ url('public/image/'.$service->image) }}" width="60px">@endif
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <div class="btn-group-horizontal" role="group" aria-label="Horizontal radio toggle button group">
                                        <input type="radio" class="btn-check" name="status" value="active" {{$service->status == 'active' ? 'checked' : ''}} id="active-radio1">
                                        <label class="btn btn-outline-success" for="active-radio1">نشط</label>
                                        <input type="radio" class="btn-check" name="status" value="inactive" {{$service->status == 'inactive' ? 'checked' : ''}} id="active-radio2">
